...
router.post(
  ...
  [
    ...
    body("punchEntries").optional().isArray().withMessage("Punch entries must be an array."),
    body("status").optional().isIn(["present", "late", "half_day", "absent", "leave"]).withMessage("Invalid attendance status."),
